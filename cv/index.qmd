...
+--------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Programming skills | -   Python & its scientific stack (fluent)                                                                                                                                             |
|                    |                                                                                                                                                                                        |
|                    |     -   Pandas, Polars, DuckDB, Numpy, Scikit-Learn, PyTorch (lightning), Statsmodels, Bambi, PyMC, Arviz, Seaborn (objects), Matplotlib, Altair, Streamlit, cvxpy, Pydantic, Hydra... |
|                    |                                                                                                                                                                                        |
|                    | -   R (when needed)                                                                                                                                                                    |
|                    |                                                                                                                                                                                        |
|                    | -   SQL (basic)                                                                                                                                                                        |
