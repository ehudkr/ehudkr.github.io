...
Highly skilled in causal inference, machine learning, (Bayesian) statistics, and data visualization. An applied researcher and data scientist with strong software engineering fundamentals. I can both run rigorous analyses or build reusable tools and frameworks that automate them, closing the full-stack loop from engineering backends of statistical engines to frontend visualization-heavy dashboards, reports, and presentations. As project leader I can elicit information from domain experts; collaborate with peers, manage them and delegate work; I can plan, break down tasks, set milestones based on agile principles; I can translate vague questions into concrete statistical hypotheses, answer them through advanced and rigor modeling, and report back to technical and non-technical stakeholders.

A T-shaped integrative thinker. I implemented biostatistics concepts into modern transformer-based deep-learning architectures to tailor NLP models for biological data, applied machine learning theories of invariance to promote fairness in genetic predictors, and used formal causal graphs to deconfound learning from multiple sources drastically improving model generalization. I'm also a passionate advocate of synthesizing engineering practices into research practices: academic workflows as git workflows, test-driven modeling, and Clean Code for research code.
...
|                |                                                                                                                                                                                                                         |
|                |     -   Steered research agenda and technical focus areas                                                                                                                                                               |
...
|                |                                                                                                                                                                                                                         |
|                |     -   Teaching academics how to apply software development fundamentals to research                                                                                                                                   |
|                |                                                                                                                                                                                                                         |
...
|                |                                                                                                                                                                                                                         |
|                |     -   Implementing concepts from generalized linear (mixed) models (e.g., zero-inflated negative-binomial regression or random effects) in PyTorch                                                                    |
|                |                                                                                                                                                                                                                         |
...
|                | :::                                                                                                                                                                                                                     |
|                |                                                                                                                                                                                                                         |
|                | -   Developing novel methodologies for finding high-resolution protein-RNA interactions using high-volume RNAseq data                                                                                                   |
+----------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
